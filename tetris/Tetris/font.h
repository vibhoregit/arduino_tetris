...
uint8_t shapes[] PROGMEM ={
	0x00, 0xE0, 0x20, 0x12,			// ```|		0-3
	0x40, 0x40, 0xC0, 0x02,			// _|		4-7
	0x00, 0x80, 0xE0, 0x12,			// |___		8-11
	0x60, 0x40, 0x40, 0x02,			// |`		12-15
	
	0x00, 0xE0, 0x80, 0x12,			// |```		16-19
	0xC0, 0x40, 0x40, 0x02,			// `|		20-23
	0x00, 0x20, 0xE0, 0x12,			// ___|		24-27
	0x40, 0x40, 0x60, 0x02,			// |_		28-31
	
	0x00, 0xE0, 0x40, 0x12,			// ^:^		32-35
	0x40, 0xC0, 0x40, 0x02,			// -|		36-39
	0x00, 0x40, 0xE0, 0x12,			// _:_		40-43
	0x40, 0x60, 0x40, 0x02,			// |-		44-47
	
	0x00, 0x60, 0xC0, 0x12,			// _:-		48-51
	0x80, 0xC0, 0x40, 0x02,			// |_		52-55
									//   |	
	0x00, 0xC0, 0x60, 0x12,			// -:_		56-59
	0x20, 0x60, 0x40, 0x02,			// _|		60-63
									//|
	0x00, 0xF0, 0x00, 0x00,			// ___		64-67
	0x20, 0x20, 0x20, 0x20,			// |		68-71
	
	0x00, 0x60, 0x60, 0x00,			// ::		72-75
};
uint8_t numbers[50] PROGMEM={
...
0x00,0x00,0x04,0x08,0x10,0x20,0x40,0x00,  // /16*9+4 bytes till this point
...
0x00,0xFF,0xFF,0xC0,0xFF,0xC0,0xFF,0xFF,  // E
...
0x00,0xFF,0xFF,0x18,0x18,0x18,0xFF,0xFF,  // I
...
0x00,0xFF,0xFF,0xC3,0xFF,0xD8,0xCC,0xC3,  // R
0x00,0xFF,0xFF,0xC0,0xFF,0x03,0xFF,0xFF,  // S
